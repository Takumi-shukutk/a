...
export default function HSRCharacterDetailPage() {
                ...
                <header className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center py-6">
                            <Link href="/hsr" className="text-gray-600 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-400 flex items-center gap-2">
    ...
    const imageUrl = `https://czmftjvxtosunimxhdzu.supabase.co/storage/v1/object/public/hsr-icons/${character['name-en']}_icon.webp`;
